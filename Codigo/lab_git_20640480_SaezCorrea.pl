...
getPregunta([LP_X|_], ID, Salida):-
    git_Universla(LP_X,1,1,[0,1],IDLP),
    IDLP == ID,
    Salida = LP_X.
...
comentUserToString([LID_X|LID_Y],LC, String, StringSalida):-
    ...
    git_Universal(Coment,0,1,[0,1],ID),
    git_Universal(Coment,0,2,[0,1],Autor),
    git_Universal(Coment,0,4,[0,1],Contenido),
    git_Universal(Coment,0,5,[0,1],Likes),
...
pregUserToString([LID_X|LID_Y], LP, LC, String, StringSalida):-
    ...
    git_Universal(Preg,0,1,[0,1],ID),
    git_Universal(Preg,0,2,[0,1],Autor),
    git_Universal(Preg,0,5,[0,1],Contenido),
    git_Universal(Preg,0,6,[0,1],ListaComentario),
    git_Universal(Preg,0,7,[0,1],Likes),
    concat(String, "    El id es ", String1),
    concat(String1, ID, String2),
    concat(String2, "\n", String3),
    concat(String3, "    El autor es ", String4),
...
userToString(Usuario, ListPregunta, ListComentario, Salida):-
   ...
   % git_Universal(Usuario,1,10,[0,1], LF),
    ...
    %pregUserToString(LPC, ListPregunta, ListComentario, "", StringLC),
...
socialNetworkToString(SN, Salida):-
    git_Universal(SN,0,3,[0,1],SLU),
    git_Universal(SN,0,4,[0,1],SLP),
    git_Universal(SN,0,5,[0,1],SLC),
    existeActivo(SLU),
